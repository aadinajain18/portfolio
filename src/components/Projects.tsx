...
const projects = [
  {
    ...
    date: '2023',
    description: 'Developed a video chat software solution for seamless and secure video communication experience for a wide range of users.',
  ...
  },
  {
    ...
    title: 'GPT Checker',
    date: '2024',
    description: 'It is an AI plagiarism detector web application for data. It is a streamlit application with the ease of understanding and an effective user interface.',
    tech: ['Streamlit', 'Python', 'NLP', 'OpenAI'],
    github: 'https://github.com/aadinajain18/GPT-CHECKER',
  },
  {
    id: '03',
    title: 'PackTrack AI',
    date: '2026',
    description: 'PackTrack AI is an AI-powered smart vision system that automates the verification of parcel packaging in commercial delivery setups.',
    tech: ['Computer Vision', 'AI', 'Python', 'IoT'],
  },
];
